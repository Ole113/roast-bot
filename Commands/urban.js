...
exports.run = async (message) => {
    ...
    if (message.content.toLowerCase().startsWith(prefixFile.prefix + "urban") && onOff.get(key, "urban") == "on") {
    ...
    } else if(message.content.toLowerCase().startsWith(prefixFile.prefix + "urban") && onOff.get(key, "urban") == "off") {
