...
exports.run = async (message) => {
    ...
    if(message.content.toLowerCase() === prefixFile.get(key, "prefix") + "meme help"){
    ...
    if (message.content.toLowerCase().startsWith(prefixFile.get(key, "prefix") + "meme") && onOff.get(key, "meme") === "on") {
        const randomMemes = Math.ceil(Math.random() * 415);
        if (message.content.toLowerCase().startsWith(prefixFile.get(key, "prefix") + "meme #")) {
    ...
    } else if(message.content.toLowerCase().startsWith(prefixFile.get(key, "prefix") + "meme") && onOff.get(key, "meme") === "off") {
