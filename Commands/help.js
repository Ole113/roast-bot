...
exports.run = async (client, message) => {
    if (message.content.toLowerCase() == prefix_file.prefix + "help") {
        ...
        let help_embed = new Discord.RichEmbed()
            ...
            .addField("on-off:", "If you want to turn any command on/off just use `r!off commandName` to turn the command off. To turn a command back on use `r!on commandName`.");
	    	.addBlankField()
