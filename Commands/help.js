...
exports.run = async (client, message) => {
    ...
    if (message.content.toLowerCase() === prefixFile.prefix + "help") {
        ...
        let helpEmbed = new Discord.RichEmbed()
            ...
            .addField("Custom Prefix:", "If you don't like Roast-Bot's prefix(r!) you can change it to anything you want by using `r!prefix newPrefix`. To view your prefix use `r!prefix`. The prefix by default is r!. **Note:** YOU CAN ONLY CHANGE YOUR PREFIX WITH `r!prefix newPrefix`. If you forget your prefix you can always change it with `r!prefix newPrefix` or view it with `r!prefix`. *Custom prefix doesnt always work the best with long text such as \"testPrefix\"*")
