...
exports.run = async (message) => {
    ...
    if(message.content.toLowerCase() === String(prefixFile.get(key, "prefix")) + "server help"){
    ...
    if (message.content.toLowerCase() === String(prefixFile.get(key, "prefix")) + "server" && String(onOff.get(key, "server")) === "on") {
    ...
    } else if(message.content.toLowerCase() === String(prefixFile.get(key, "prefix")) + "server" && String(onOff.get(key, "server")) === "off") {
