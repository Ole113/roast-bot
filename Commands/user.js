...
exports.run = async (message) => {
    ...
    if (message.content.toLowerCase().startsWith(prefixFile.prefix + "user ") && onOffFile.user === "on") {
    ...
    } else if(message.content.toLowerCase().startsWith(prefixFile.prefix + "user ") && onOffFile.user === "off") {
        return message.channel.send("This command has been turned off by an administrator.");      
    }

    if (message.content.toLowerCase() === prefixFile.prefix + "user" && onOffFile.user === "on") {
        var status = "default";
