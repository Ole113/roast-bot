...
exports.run = async (message) => {
    ...
    if(message.content.toLowerCase() === prefixFile.get(key, "prefix") + "invite help" || message.content.toLowerCase() === "rb!"){
...
if(message.content.toLowerCase() === prefixFile.get(key, "prefix") + "invite" || message.content.toLowerCase() === "rb!") {
