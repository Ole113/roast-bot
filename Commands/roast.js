...
exports.run = async (message) => {
	...
	if (message.content.toLowerCase().startsWith(prefixFile.prefix + "roast") && onOffFile.roast === "on") {
		if (message.content.toLowerCase() === prefixFile.prefix + "roast") {
			...
			if (randomRoasts > 135 && (customRoastFile[randomRoasts - 136].roasts == "You haven't set this custom roasts yet! Use `r!croast help` to learn how to." || customRoastFile[randomRoasts - 137].roasts == "You haven't set this custom roasts yet! Use `r!croast help` to learn how to." || customRoastFile[randomRoasts - 138].roasts == "You haven't set this custom roasts yet! Use `r!croast help` to learn how to." || customRoastFile[randomRoasts - 139].roasts == "You haven't set this custom roasts yet! Use `r!croast help` to learn how to.")) {
