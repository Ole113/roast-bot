...
exports.run = async (message) => {
    ...
    const number = word.slice(String(prefixFile.get(key, "prefix")).length + 5, word.length);
    const int = Number(number);
    if (message.content.toLowerCase().startsWith(String(prefixFile.get(key, "prefix")) + "clear") && String(onOff.get(key, "clear")) === "on" || message.content.toLowerCase() === "rb!") {
    ...
    } else if(message.content.toLowerCase().startsWith(String(prefixFile.get(key, "prefix") + "clear")) && String(onOff.get(key, "clear")) === "off" || message.content.toLowerCase() === "rb!") {
