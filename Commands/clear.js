...
exports.run = async (message) => {
    ...
    if (message.content.toLowerCase().startsWith(prefix + "clear") && onOff.get(key, "clear") === "on" || message.content.toLowerCase() === "rb!") {
    ...
    } else if(message.content.toLowerCase().startsWith(prefix + "clear")) && onOff.get(key, "clear") === "off" || message.content.toLowerCase() === "rb!") {
