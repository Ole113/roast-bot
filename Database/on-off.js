...
exports.run = async (message) => {
	onOff.defer.then(() => {
		...
		if (!message.member.hasPermission("MANAGE_MESSAGES") && (message.content.toLowerCase().startsWith(prefix_file.prefix + "off") || message.content.toLowerCase().startsWith(prefix_file.prefix + "on"))) {
