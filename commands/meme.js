...
exports.run = async (message) => {
    ...
    connection.query(`SELECT * FROM roast_bot_custom_prefix WHERE guildID = "${message.guild.id}";`, function (err, result) {
        ...
        if (message.content.toLowerCase().startsWith(prefix + "meme") || message.content.toLowerCase() === "rb!") {
        ...
        } /*else if(message.content.toLowerCase().startsWith(prefix + "meme") || message.content.toLowerCase().startsWith("rb!meme")) {
