...
exports.run = async (client, message) => {
    ...
    connection.query(`SELECT * FROM roast_bot_on_off WHERE guildID = "${message.guild.id}";`, function (err, result) {
        ...
        if ((message.content.toLowerCase().startsWith(`${prefixFile.prefix}bot on`) || message.content.toLowerCase().startsWith(`${prefixFile.prefix}bot off`)) && !message.member.hasPermission("ADMINISTRATOR")) {
